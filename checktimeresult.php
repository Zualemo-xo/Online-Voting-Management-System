...
<script>
var StartcountDownDate = new Date("June 1, 2020 15:27:25").getTime();
var EndcountDownDate=new Date("June 3, 2020 1:04:25").getTime();
...
if (distance < 0) {
   ...
   // var x = setInterval(function() {
    ...
    document.getElementById("demo").innerHTML = "<br><b>Please wait!Elections have begun.Results will be visible once elections come to an end.<br>Elections will end by:"+days + "d " + hours + "h "
    + minutes + "m ";
    ...
    if(left<0)
    {
      document.getElementById("demo").innerHTML = "<br><br><br><b>Redirecting to the results page.";
      setTimeout(function(){
       window.location = "http://localhost/NEWDBMSPROJ/displaychart.php";
      },delay);
    }
 }
}, 1000);
